import{_ as a,c as i,o as n,a2 as l}from"./chunks/framework.C4ft4DOy.js";const p="/v4-docs/settings.png",o=JSON.parse('{"title":"配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/configure.md","filePath":"guide/configure.md"}'),e={name:"guide/configure.md"};function t(h,s,k,d,c,r){return n(),i("div",null,[...s[0]||(s[0]=[l(`<h1 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h1><h2 id="环境配置" tabindex="-1">环境配置 <a class="header-anchor" href="#环境配置" aria-label="Permalink to &quot;环境配置&quot;">​</a></h2><p>默认提供三套环境配置，分别为：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-S7nK4" id="tab-fZnxE5d" checked><label data-title=".env.development 开发环境" for="tab-fZnxE5d">.env.development 开发环境</label><input type="radio" name="group-S7nK4" id="tab-VYKyvXs"><label data-title=".env.test 测试环境" for="tab-VYKyvXs">.env.test 测试环境</label><input type="radio" name="group-S7nK4" id="tab-hHt3UMd"><label data-title=".env.production 生产环境" for="tab-hHt3UMd">.env.production 生产环境</label></div><div class="blocks"><div class="language-yaml vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 应用配置面板</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">VITE_APP_TITLE = One-step-admin</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">VITE_OPEN_PROXY = false</span></span></code></pre></div><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 应用配置面板</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 是否在打包后生成存档，支持 zip 和 tar</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">VITE_BUILD_ARCHIVE =</span></span></code></pre></div></div></div><p>其中 <code>VITE_APP_SETTING</code> <code>VITE_APP_TITLE</code> <code>VITE_APP_API_BASEURL</code> <code>VITE_APP_DEBUG_TOOL</code> <code>VITE_APP_DISABLE_DEVTOOL</code> 为必要配置，即不管是在开发、测试，还是生产环境都需要使用到。而其余配置则在不同环境下有不同用途，例如开发环境用于本地开发使用，测试环境和生产环境用于构建使用。</p><p>开发者可根据实际业务需求进行扩展，如果对这块不熟悉，请阅读 <a href="https://cn.vitejs.dev/guide/env-and-mode.html" target="_blank" rel="noreferrer">Vite - 环境变量和模式</a> 章节。</p><div class="warning custom-block"><p class="custom-block-title">注意</p><p><code>VITE_APP_SETTING</code> 该变量是开启应用配置面板，目的是方便开发者在开发阶段调试，生产环境下默认关闭，也建议关闭。</p><p>如果希望提供用户一些定制化的能力，可以开启偏好设置，详细可阅读《<a href="./preferences.html">用户偏好设置</a>》</p></div><h2 id="应用配置-框架配置" tabindex="-1">应用配置（框架配置） <a class="header-anchor" href="#应用配置-框架配置" aria-label="Permalink to &quot;应用配置（框架配置）&quot;">​</a></h2><p>开发者请在 <code>/src/settings.ts</code> 文件中设置自定义配置，而 <code>/src/settings.default.ts</code> 为框架的默认配置，请勿在该文件内修改。</p><p>关于配置的类型定义，可以在 <code>/src/types/globals.d.ts</code> 文件中查阅。</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 这是基础版演示源码里的自定义配置示例</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  },</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><div class="warning custom-block"><p class="custom-block-title">注意</p><p>如果文档中提供的配置介绍，在你本地的开发环境中报错或者无法生效，说明你使用的版本不支持或者配置参数有变动，你可以打开 <code>/src/settings.default.ts</code> 查看当前版本的完整配置作为参考。并且如果你使用的是 Visual Studio Code ，鼠标悬浮到属性上时，会有属性的介绍：</p><p><img src="`+p+'" alt="" data-zoomable=""></p></div>',12)])])}const g=a(e,[["render",t]]);export{o as __pageData,g as default};
